...
void Datacenter::exportAuthorization() {
    ...
    ConnectionsManager::getInstance(instanceNum).sendRequest(request, [this](TLObject *response, TL_error *error, int32_t networkType, int64_t responseTime, int64_t msgId, int32_t dcId) {
        if (error == nullptr) {
            ...
            ConnectionsManager::getInstance(instanceNum).sendRequest(request2, [this](TLObject *response2, TL_error *error2, int32_t networkType, int64_t responseTime, int64_t msgId, int32_t dcId) {
                if (error2 == nullptr) {
                    authorized = true;
